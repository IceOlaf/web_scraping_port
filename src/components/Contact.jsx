    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "iceolaf0101@jsmastery.pro",
        ...
        >
          ...
          <label className='flex flex-col'>
            ...
            <input
              type='email'
              name='email'
              value="iceolaf0101@gmail.com"
              onChange={handleChange}
              placeholder="What's my web address?"
              className='bg-customize py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
            ...
            <textarea
              rows={7}
              name='message'
              value="As I am a Email Support, Web Scraping and Lead Generation expert, I am looking for a client to whom I can contribute my skills and passion."
              onChange={handleChange}
